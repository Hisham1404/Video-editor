...
| **gemini-3.5-flash-lite** | 859 | 45.8% | **77.8%** | — | **stage 3 default.** Dead heat with the classifier (p=0.95); best second tagger measured |
...
| nemotron-3-nano-omni-30b | 859 | 52.5% | 71.2% | — | API; 284 tok/image, 4× cheaper than Gemini |
...
|---|---|---|---|---|
| qwen/qwen3.8-27b (Groq) | film-grab | 70 | 52.9% | abandoned; free tier caps at 200k tokens/day against 1.78M needed |
